          ...
          {kpisLoading ? (
            ...
            <>
              ...
              <KPICard
                ...
                value={(kpis?.delivery_rate * 100) ?? 0}
                format="percentage"
                icon={<Truck className="h-5 w-5" />}
              />
              <KPICard
                title="Pedidos que cumplieron tiempos SLA."
                value={(kpis?.sla_compliance * 100) ?? 0}
                format="percentage"
              ...
              <KPICard
                ...
                value={(kpis?.stock_reservation_rate * 100) ?? 0}
                format="percentage"
              ...
              <KPICard
                ...
                value={(kpis?.fulfillment_rate * 100) ?? 0}
                format="percentage"
                icon={<CheckCircle className="h-5 w-5" />}
              />
              ...
              <KPICard
                ...
                value={(kpis?.payment_failure_rate * 100) ?? 0}
                format="percentage"
              ...
              <KPICard
                ...
                value={(kpis?.payment_success_rate * 100) ?? 0}
                format="percentage"
